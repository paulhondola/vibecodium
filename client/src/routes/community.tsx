...
const DIFFICULTY_STYLES = {
	...
	medium: {
		label: "Medium",
		className: "bg-yellow-500/15 border-yellow-500/40 text-yellow-400",
	},
	hard: {
		label: "Hard",
			...
			<div className="max-w-4xl mx-auto px-6 py-12">
				...
				<div className="text-center mb-12">
					...
					<p className="text-gray-400 text-sm max-w-xl mx-auto">
						Browse help requests from the community. Open any project directly
						in VibeCodium's sandbox to debug together.
					</p>
				</div>
				...
				{isLoading ? (
					...
					<div className="text-center py-24 text-gray-500">
						...
						<p className="text-sm">
							No help requests yet. Be the first to post!
						</p>
					</div>
				) : (
									...
									<div className="flex-1 min-w-0">
										...
										<div className="flex items-center gap-3 mb-2 flex-wrap">
											...
											{(() => {
												...
												return (
													<span
														className={`px-2 py-0.5 rounded-full border text-[10px] font-bold uppercase tracking-widest ${d.className}`}
													>
														{d.label}
													</span>
												);
