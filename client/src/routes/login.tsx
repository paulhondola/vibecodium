            ...
            `,
				...
				<div className="relative z-10 p-10 flex flex-col items-center text-center">
					...
					<p className="text-sm text-gray-400 mb-10 max-w-xs leading-relaxed">
						The premium collaborative environment for modern developers. Secure
					...
					>
						...
						{!isLoading && (
							<ArrowRight
								size={16}
								className="absolute right-6 opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all text-cyan-400"
							/>
						)}
					</button>
