		...
		<div className="min-h-screen bg-[#02040a] text-[#f8fafc] font-['Inter'] selection:bg-[rgba(168,85,247,0.3)] selection:text-white overflow-x-hidden">
			...
			<nav className="fixed top-0 z-[100] flex justify-between items-center w-full px-6 h-14 glass-card rounded-none border-x-0 border-t-0 border-b-[rgba(168,85,247,0.1)]">
				...
				<div className="flex items-center gap-4">
					...
					<button
						onClick={() =>
							isAuthenticated ? navigate({ to: "/profile" }) : onEnter()
						}
					...
					>
						<span className="relative z-10 flex items-center gap-1.5">
							{isLoading ? (
								...
								<>
									<span className="material-symbols-outlined text-[16px] leading-[1]">
										person
									</span>
			...
			<main className="pl-16 pt-14 pb-8 overflow-x-hidden">
				...
				<section className="relative min-h-[90vh] flex flex-col items-center justify-center px-6 warp-speed">
					...
					<div className="absolute inset-0 pointer-events-none z-10">
						...
						<div
							className="data-stream top-[45%] opacity-30"
							style={{ animationDelay: "1.5s" }}
						></div>
						<div
							className="data-stream top-[70%]"
					...
					<div className="z-20 text-center max-w-5xl mx-auto space-y-10 animate-float pt-20">
						<h1 className="text-6xl md:text-8xl font-['Space_Grotesk'] font-bold tracking-tighter text-[#f8fafc] leading-[0.9] text-glow">
							The Future of <br />
							<span className="text-transparent bg-clip-text bg-gradient-to-r from-[#A855F7] via-white to-[#3B82F6] animate-pulse">
						...
						<p className="text-xl md:text-2xl text-slate-400 font-light max-w-3xl mx-auto tracking-tight">
							...
							<span className="text-[rgba(59,130,246,0.8)]">
								A high-density workspace for the modern digital architect.
							</span>
						</p>
						...
						<div className="flex flex-wrap justify-center gap-6 pt-6">
							<button
								onClick={() =>
									isAuthenticated ? navigate({ to: "/dashboard" }) : onEnter()
								}
					...
					<div className="z-20 mt-20 w-full max-w-5xl mx-auto rounded-2xl overflow-hidden glass-card border-[rgba(168,85,247,0.2)] sentient-ai transform rotate-1 perspective-1000">
						<div className="flex items-center justify-between px-6 py-3 bg-[rgba(26,31,46,0.4)] border-b border-[rgba(168,85,247,0.1)]">
							...
							<div className="text-[10px] font-['Space_Grotesk'] text-slate-500 uppercase tracking-[0.4em]">
								system.core — vibecodium_v4
							</div>
						...
						<div className="flex flex-col md:flex-row h-[450px]">
							<div className="flex-1 p-8 font-mono text-sm leading-relaxed overflow-hidden bg-black/40">
								...
								<div className="relative ml-14 my-6 p-6 rounded-xl glass-card border-l-4 border-[#A855F7] sentient-ai">
									<div className="flex items-center gap-3 mb-3">
										<span className="material-symbols-outlined text-[#A855F7] text-lg fill-1 animate-pulse">
											psychology
										</span>
										<span className="text-[10px] font-['Space_Grotesk'] font-black text-[#A855F7] uppercase tracking-[0.3em]">
											AI Sentient Optimization
										</span>
									</div>
							...
							<div className="hidden md:block w-80 bg-[rgba(10,12,20,0.6)] border-l border-[rgba(168,85,247,0.1)] p-6 font-mono text-[11px] backdrop-blur-xl">
								...
								<div className="text-slate-500">
									$ vibecodium deploy --global
								</div>
								<div className="text-slate-400 mt-2">
									Connecting to Neural Edge...
								</div>
								<div className="text-[#A855F7] mt-3 font-bold">
									SYCHRONIZING [████████████] 100%
								</div>
								<div className="text-[#10B981] mt-2">
									DEPLOYED: https://void-x1.vibecodium.dev
								</div>
					...
					<div className="mb-20 text-center lg:text-left flex flex-col lg:flex-row items-end justify-between gap-10">
						<div className="max-w-2xl">
							<h2 className="text-5xl font-['Space_Grotesk'] font-bold tracking-tighter mb-6 text-glow">
								Everything you need.{" "}
								<span className="text-[#A855F7]">Nothing you don't.</span>
							</h2>
							<p className="text-slate-400 text-lg">
								A real IDE in the browser — with live collaboration, an AI agent
								that shows its work, and sandboxed execution for six languages.
							</p>
						</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-12 gap-8">
							...
							<div className="flex flex-col md:flex-row gap-10 h-full">
								<div className="flex-1">
									<div className="mb-8 w-14 h-14 rounded-2xl bg-[rgba(59,130,246,0.2)] flex items-center justify-center border border-[rgba(59,130,246,0.3)] shadow-[0_0_20px_rgba(59,130,246,0.3)]">
										<span className="material-symbols-outlined text-[#3B82F6] text-3xl fill-1">
											group
										</span>
									</div>
									<h3 className="text-3xl font-['Space_Grotesk'] font-bold mb-5 tracking-tight">
										Live Collaboration
									</h3>
									<p className="text-slate-400 leading-relaxed mb-8">
										Multiple developers, one editor — powered by Yjs CRDT.
										Colored cursors show exactly who is editing what file.
										Changes merge conflict-free in real time over WebSocket.
									</p>
									<div className="flex items-center gap-3 flex-wrap">
										<span className="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest bg-[rgba(59,130,246,0.15)] border border-[rgba(59,130,246,0.3)] text-[#3B82F6]">
											Yjs CRDT
										</span>
										<span className="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest bg-[rgba(59,130,246,0.15)] border border-[rgba(59,130,246,0.3)] text-[#3B82F6]">
											Y-Monaco
										...
										<span className="ml-2 text-[10px] text-[#10B981] uppercase tracking-[0.3em] animate-pulse">
											● Live Now
										</span>
									</div>
								</div>
								<div className="flex-1 hidden lg:flex flex-col gap-3 justify-center font-mono text-xs">
									<div className="p-3 bg-black/40 rounded-xl border border-white/5 flex items-center gap-3">
										...
										<span className="text-slate-400">
											Alex is editing{" "}
											<span className="text-white">server/index.ts</span>
										</span>
									</div>
									<div className="p-3 bg-black/40 rounded-xl border border-white/5 flex items-center gap-3">
						...
						<div className="md:col-span-4 glass-card p-10 flex flex-col justify-between group">
							<div className="mb-8 w-14 h-14 rounded-2xl bg-[rgba(16,185,129,0.2)] flex items-center justify-center border border-[rgba(16,185,129,0.3)]">
								<span className="material-symbols-outlined text-[#10B981] text-3xl">
									rocket_launch
								</span>
							</div>
							<div>
								<h3 className="text-2xl font-['Space_Grotesk'] font-bold mb-4 tracking-tight">
									One-Click Deploy
								</h3>
								<p className="text-slate-400 text-sm leading-relaxed">
									Connect your Vercel token in profile settings and deploy your
									project straight from the editor. Deployment logs stream back
									in the terminal in real time.
								</p>
							</div>
						</div>
							...
							<div className="relative bg-[#0a0c14] p-12 rounded-[14px] flex flex-col lg:flex-row items-start gap-16">
								<div className="lg:w-3/5">
									<div className="inline-flex items-center gap-3 mb-8 px-4 py-2 rounded-xl bg-[rgba(168,85,247,0.1)] border border-[rgba(168,85,247,0.2)]">
										<span className="material-symbols-outlined text-[#A855F7] fill-1 sentient-ai">
											bolt
										</span>
										<span className="text-xs font-black text-[#A855F7] uppercase tracking-[0.4em]">
											AI Agent
										</span>
									</div>
									<h3 className="text-4xl font-['Space_Grotesk'] font-bold mb-6 text-glow">
										AI that shows its work
									</h3>
									<p className="text-slate-400 text-lg leading-relaxed max-w-2xl mb-6">
										The agent streams token-by-token via SSE, reads your files,
										writes proposed changes, and runs commands — all in a tool
										loop. Every edit surfaces as a diff you{" "}
										<span className="text-[#10B981] font-semibold">Accept</span>{" "}
										or{" "}
										<span className="text-red-400 font-semibold">Reject</span>{" "}
										inline in Monaco before anything touches your files.
									</p>
									<div className="flex gap-3 flex-wrap">
										<span className="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest bg-[rgba(168,85,247,0.15)] border border-[rgba(168,85,247,0.3)] text-[#A855F7]">
											SSE Streaming
										</span>
										<span className="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest bg-[rgba(168,85,247,0.15)] border border-[rgba(168,85,247,0.3)] text-[#A855F7]">
											Tool Loop
								...
								<div className="lg:w-2/5 w-full">
									<div className="space-y-3 font-mono text-xs">
										<div className="p-4 glass-card border-[rgba(168,85,247,0.3)] rounded-2xl sentient-ai">
											<div className="text-[#A855F7] font-bold mb-1 text-[10px] uppercase tracking-widest">
												Agent → read_file
											</div>
											<span className="text-slate-400">
												Reading{" "}
										...
										<div className="p-4 glass-card border-[rgba(168,85,247,0.3)] rounded-2xl sentient-ai">
											...
											<span className="text-slate-400">
												...
												<span className="text-white">agent.ts</span>
											</span>
											<div className="flex gap-2 mt-3">
												<button className="px-3 py-1 text-[10px] bg-[#10B981]/20 text-[#10B981] border border-[#10B981]/30 font-bold rounded uppercase tracking-widest">
													✓ Accept
												</button>
												<button className="px-3 py-1 text-[10px] bg-red-500/10 text-red-400 border border-red-500/20 font-bold rounded uppercase tracking-widest">
													✗ Reject
												</button>
											</div>
										</div>
										<div className="p-4 glass-card border-white/5 rounded-2xl opacity-60">
											<div className="text-[#10B981] font-bold mb-1 text-[10px] uppercase tracking-widest">
				...
				<section className="py-32 bg-black/40 relative">
					<div className="max-w-7xl mx-auto px-6">
						<div className="text-center mb-20">
							<h2 className="text-5xl font-['Space_Grotesk'] font-bold tracking-tighter mb-6 text-glow">
								Built for real{" "}
								<span className="text-[#A855F7]">developer workflows</span>
							</h2>
							<p className="text-slate-400 text-lg max-w-2xl mx-auto">
								From sandboxed execution to code history — every feature solves
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
							<div className="flex gap-6 group p-8 glass-card rounded-2xl hover:border-[rgba(59,130,246,0.3)] transition-colors">
								...
								<div>
									...
									<p className="text-slate-500 text-sm leading-relaxed">
										Run Python, Node, C++, Rust, Go, and Bun inside isolated
										Docker containers. 2 GB RAM limit, network off, 3-second
										timeout — code can't escape.
									</p>
								</div>
							</div>
							...
							<div className="flex gap-6 group p-8 glass-card rounded-2xl hover:border-[rgba(168,85,247,0.3)] transition-colors">
								<div className="flex-shrink-0 w-12 h-12 glass-card flex items-center justify-center border-[rgba(168,85,247,0.3)] group-hover:scale-110 transition-transform rounded-xl">
									<span className="material-symbols-outlined text-[#A855F7] text-xl">
										history
									</span>
								</div>
								<div>
									...
									<p className="text-slate-500 text-sm leading-relaxed">
										Click any checkpoint to restore that file state instantly —
										or ask the AI to explain what changed between two points.
									</p>
								</div>
							</div>
							...
							<div className="flex gap-6 group p-8 glass-card rounded-2xl hover:border-[rgba(16,185,129,0.3)] transition-colors">
								...
								<div>
									...
									<p className="text-slate-500 text-sm leading-relaxed">
										Static analysis runs before every execution. Critical issues
										like fork bombs and disk wipers are blocked outright. High,
										medium, and low findings surface with explanations.
									</p>
								</div>
							</div>
							...
							<div className="flex gap-6 group p-8 glass-card rounded-2xl hover:border-[rgba(59,130,246,0.3)] transition-colors">
								...
								<div>
									...
									<p className="text-slate-500 text-sm leading-relaxed">
										Generate a shareable link with a signed token — valid for 7
										days. Recipients can access the project without an account.
										Revoke anytime.
									</p>
								</div>
							</div>
							...
							<div className="flex gap-6 group p-8 glass-card rounded-2xl hover:border-[rgba(168,85,247,0.3)] transition-colors">
								...
								<div>
									...
									<p className="text-slate-500 text-sm leading-relaxed">
										A real xterm.js terminal backed by a PTY process over
										WebSocket. Run a command and everyone in the session sees
							...
							<div className="flex gap-6 group p-8 glass-card rounded-2xl hover:border-[rgba(16,185,129,0.3)] transition-colors">
								...
								<div>
									...
									<p className="text-slate-500 text-sm leading-relaxed">
										Post your repo for community code review. Or spin the
										CoderMatch wheel and get randomly paired with another
										developer for a session.
									</p>
								</div>
							</div>
						</div>
			...
			<footer className="fixed bottom-0 w-full flex justify-between items-center px-4 z-[100] glass-card h-8 border-x-0 border-b-0 border-t-[rgba(168,85,247,0.2)] rounded-none bg-black">
				<div className="flex items-center gap-6 h-full">
					...
					<div className="hidden sm:flex items-center gap-6">
						...
						<div className="text-slate-500 hover:text-white transition-colors font-['JetBrains_Mono'] text-[9px] uppercase tracking-[0.2em] cursor-pointer">
							Problems{" "}
							<span className="bg-red-500 text-white px-1.5 rounded-full ml-1 text-[8px]">
								0
							</span>
						</div>
					</div>
