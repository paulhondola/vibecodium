...
export default function DashboardFooter({ repoCount, workspaceCount }: DashboardFooterProps) {
	return (
		<footer className="fixed bottom-0 w-full flex justify-between items-center px-6 z-[120] bg-[rgba(10,12,20,0.6)] backdrop-blur-xl border-t border-[rgba(168,85,247,0.2)] shadow-[0_8px_32px_0_rgba(0,0,0,0.4)] h-8 bg-black">
			<div className="flex items-center gap-8 h-full">
				...
				<div className="hidden md:flex items-center gap-8">
					<div className="text-slate-500 font-['JetBrains_Mono'] text-[8px] uppercase tracking-[0.3em]">{repoCount} repos</div>
					<div className="text-slate-500 font-['JetBrains_Mono'] text-[8px] uppercase tracking-[0.3em]">{workspaceCount} workspaces</div>
				</div>
			</div>
