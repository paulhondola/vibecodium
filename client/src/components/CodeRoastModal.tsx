...
export default function CodeRoastModal({
	code,
	fileName,
	onClose,
}: CodeRoastModalProps) {
	...
	const openerRef = useRef(
		ROAST_OPENERS[Math.floor(Math.random() * ROAST_OPENERS.length)],
	);
				...
				<div className="flex items-center justify-between px-5 py-4 bg-gradient-to-r from-orange-500/10 to-red-500/10 border-b border-orange-500/20 shrink-0">
					<div className="flex items-center gap-3">
						...
						<div>
							...
							<p className="text-[10px] text-orange-400/70 font-mono uppercase tracking-widest">
								{fileName}
							</p>
						</div>
					</div>
					...
					{isLoading && (
						<div className="flex flex-col items-center justify-center py-12 gap-4">
							...
							<p className="text-sm text-gray-400 font-medium">
								AI is reading your code and judging you...
							</p>
