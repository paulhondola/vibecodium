...
export default function CommunityHelpModal({
	isOpen,
	onClose,
	repoUrl,
}: CommunityHelpModalProps) {
									...
									{(["easy", "medium", "hard"] as const).map((level) => {
										const styles = {
											easy: {
												...
												idle: "border-white/10 text-slate-500 hover:border-emerald-500/30 hover:text-emerald-400",
											},
											medium: {
												active:
													"bg-yellow-500/20 border-yellow-500/60 text-yellow-400",
												idle: "border-white/10 text-slate-500 hover:border-yellow-500/30 hover:text-yellow-400",
											},
											hard: {
												active: "bg-red-500/20 border-red-500/60 text-red-400",
												idle: "border-white/10 text-slate-500 hover:border-red-500/30 hover:text-red-400",
											},
										};
