...
describe("Yjs CRDT collaboration", () => {
    ...
    test("concurrent inserts at different positions both survive merge", () => {
        ...
        clientA.on("update", (u: Uint8Array, o: unknown) => { if (o === "local") deltaA = u; });
        clientB.on("update", (u: Uint8Array, o: unknown) => { if (o === "local") deltaB = u; });
    ...
    test("delta from client A reaches client B via server relay", () => {
        ...
        clientA.on("update", (u: Uint8Array, o: unknown) => { if (o === "local") delta = u; });
        clientA.transact(() => clientA.getText("content").insert(5, "-edit"), "local");
    ...
    test("base64 round-trip preserves Yjs update bytes", () => {
        ...
        doc.on("update", (u: Uint8Array, o: unknown) => { if (o === "local") captured = u; });
    ...
    test("time-travel restore with local origin produces a broadcastable delta", () => {
        ...
        doc.on("update", (u: Uint8Array, o: unknown) => { if (o === "local") deltas.push(u); });
